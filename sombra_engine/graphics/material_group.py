from pyglet.graphics import Group, ShaderGroup, ShaderProgram, Texture
...
class MaterialGroup(ShaderGroup):
    def __init__(
        ...
        self.set_textures(self.textures, program)
